  ...
  return (
    <div className='bg-[#F6FBE9] mx-[80px] h-[1150px] mt-12 rounded-[12px]'>
        ...
        <div className='flex flex-row justify-between'>
            ...
            <p className='bg-[#234338] h-[64px] text-[white] py-[16px] px-[24px] rounded-[8px] text-[20px] font-medium w-fit'>premium Plan</p>
            <p className='bg-[#234338] text-[white] h-[64px] py-[16px] px-[24px] rounded-[8px] text-[20px] font-medium w-fit'>Ultimate Plan</p>
        </div>
