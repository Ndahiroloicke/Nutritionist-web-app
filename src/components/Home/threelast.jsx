...
function Tritity() {
  return (
    <div>
      <div className="last-feature w-[630px] h-[250px] bg-[#F6FBE9]">
        <div className="pic-and-t ">
          <img src={divine4} alt="" />
          <h3 className="text-[20px] font-semibold">Guidance from Certified Nutritionists</h3>
        </div>
      ...
      <div className="last-feature w-[630px] h-[250px] bg-[#F6FBE9]">
        <div className="pic-and-t2 pic-and-t">
          <img src={divine5} alt="" />
          <h3 className="text-[20px] font-semibold">Meal Planning and Recipes</h3>
        </div>
        <div className="pt-[20px] pb-[60px] px-[40px]">
      ...
      <div className="last-feature w-[630px] h-[250px] bg-[#F6FBE9]">
        <div className="pic-and-t3 pic-and-t">
          <img src={divine3} alt="" />
          <h3 className="text-[20px] font-semibold">Nutritional Education and Workshops</h3>
        </div>
        <div className="pt-[20px] pb-[60px] px-[40px]">
