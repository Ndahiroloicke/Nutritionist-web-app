...
import pic from "../../../public/assets/45f09264-8b59-4a1a-b144-e7e5ce462478.png";
const Overview = ({ paragraph, username, userpic }) => {
  return (
    <>
      <div className="bg-[#FAFDF2] w-full sm:max-w-[413.33px] rounded-[10px] border-[#EEF8D3] border-[0.5px] h-[320px]">
