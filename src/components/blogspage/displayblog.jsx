...
const Displayblog = () => {
  return (
    <div>
        ...
        <div>
          <Blogsample
          cla="bg-[#EEF8D3] w-[610px] h-[532px] pl-[40px] mt-[100px] rounded-tl-[30px] border-[#828d65] border-[0.1px]"
          pic={plate}
          ...
          />
          <Blogsample
          cla="bg-[#EEF8D3] w-[610px] h-[532px] pl-[40px] border-[#828d65] border-[0.1px]"
          pic={image1}
            blogh="Weight Loss Tips"
          ...
          />
          <Blogsample
          cla="bg-[#EEF8D3] w-[610px] h-[532px]  rounded-bl-[30px] pl-[40px] border-[#828d65] border-[0.1px]"
          pic={image9}
        ...
        <div>
          <Blogsample
          cla="bg-[#EEF8D3] w-[610px] h-[532px] mt-[100px] pl-[40px] rounded-tr-[30px] border-[#d3d3d3] border-[0.1px]"
          pic={image}
            blogh="Weight Loss Tips"
          ...
          />
          <Blogsample
          cla="bg-[#EEF8D3] w-[610px] mb-[100px] rounded-br-[30px] h-[532px] pl-[40px] border-[#828d65] border-[0.01px]"
          pic={image10}
            blogh="Recipes and Meal Planning"
